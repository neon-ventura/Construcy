    ...
    return (
        <>
            ...
            <div className={styles.content}>
                ...
                <div className={styles.body_img}><img className={styles.img} src="/about/img-1.webp" alt="" /></div>
                ...
                <div className={styles.section_mission}>
                    <div className={styles.about_ourMission}>
                        ...
                        <p className={styles.p3}>
                        Nosso compromisso é ser referência no setor da construção, entregando obras que se destacam pela durabilidade, segurança e impacto positivo no ambiente e na sociedade.
                        </p>
                    </div>
                    <img className={styles.img2} src="/about/img-2.webp" alt="" />
                </div>
            </div>
